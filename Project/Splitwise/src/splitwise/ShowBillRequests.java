...
public class ShowBillRequests extends javax.swing.JFrame {
    ...
    public ShowBillRequests(int user_id) {
        ...
        // The will load all the values for the UI Labels
    ...
    // Event handler for Participate
    // This function will be called when the "Participate" Button is clicked.
    ...
    // effect: loads all the values for the UI Labels on next/ back button clicks
