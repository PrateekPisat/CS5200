...
public class UserHomepage extends javax.swing.JFrame {
    ...
    public UserHomepage(int userid)
    {
        ...
        initComponents();
        // This will hide all the balance buttons, and labels.
        hideBalances();
        user_id = userid;
        api a = new api();
        ...
        // this will load/ set the values for the UI Labels
        ...
        // Checking if some bill requests are pending, if not, disable the button to avoid exceptions.
        HandleRequests.setEnabled((a.getPendingRequests(this.user_id) <= 0 ) ? false : true);
        budget = a.getUserBudget(user_id);
        // Checking if some bill requests are pending or if the user has created
        // any bills if not, disable the button to avoid exceptions.
        ...
        if(userBalances.size() > 0)
            // setting who to pay and how much.
            updateBalances(a);
        a.closeConnection();
    }
    ...
    // Event handler for NewBill
    // This function will be called when the "New Bill" Button is clicked.
    ...
    // Event handler for HandleRequests
    // This function will be called when the "Handle Requests" Button is clicked.
    ...
    // Event handler for MyBills
    // This function will be called when the "My Bills" Button is clicked.
    ...
    // Event handler for setBudget
    // This function will be called when the "Set Budget" Button is clicked.
    ...
    // Event handler for ClearDebt1
    // This function will be called when the frst "Clear Debt" Button is clicked.
    private void ClearDebtButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClearDebtButton1ActionPerformed
        // TODO add your handling code here:
        api a = new api();
        if(a.yetToAnswerRequests(creditor1, this.user_id) > 0)
        {
    ...
    // Event handler for ClearDebt2
    // This function will be called when the second "Clear Debt" Button is clicked.
    private void ClearDebtButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClearDebtButton2ActionPerformed
        // TODO add your handling code here:
         api a = new api();
         if(a.yetToAnswerRequests(creditor2, this.user_id) > 0)
        {
            MessageBox.setForeground(Color.RED);
            MessageBox.setText("People Still Have To Fill Some Bills by That User");
            return;
        }
        if(a.clearDebt(user_id, creditor2) == -1)
            MessageBox.setText("Something Went Wrong");
        else
        {
            MessageBox.setText("Debt Paid!");
    ...
    // Event handler for ClearDebt3
    // This function will be called when the third "Clear Debt" Button is clicked.
    private void ClearDebtButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClearDebtButton3ActionPerformed
        // TODO add your handling code here:
         api a = new api();
         if(a.yetToAnswerRequests(creditor3, this.user_id) > 0)
        {
            MessageBox.setForeground(Color.RED);
            MessageBox.setText("People Still Have To Fill Some Bills by That User");
            return;
    ...
    // Event handler for LoadPrevious
    ...
    // Event handler for DeleteUser
    // This function will be called when the "Delete Profile" Button is clicked.
    ...
    // Event handler for EditUser
    // This function will be called when the "Edit User" Button is clicked.
    ...
    // updateBalances: api -> void
    // input: an api instance.
    // effect: Appropriately loads the debt labes with vales and the amount
    //         to be paid.
    ...
    // hideBalances: api -> void
    // effect: hides all the debt labes with vales and the amount
    //         to be paid, primarily used for relaoding the values after paying
    //         a specific debt or after clicking the next/previous button.
