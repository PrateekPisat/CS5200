...
public class ShowCreatedBills extends javax.swing.JFrame {
    ...
    public ShowCreatedBills(int user_id) {
        // This will init all the UI Componenets
        initComponents();
        api a = new api();
        this.user_id = user_id;
        userBills = a.getCreatedBills(user_id);
        currentBill = userBills.get(current);
        //This will load all the values on the UI Lables.
        updateContents();
        a.closeConnection();
    }
    ...
    // Event handler for HandleParticipation
    // This function will be called when the "Handle Participation" Button is clicked.
    ...
    // updateComponents: void -> void
    // Effect: This will load the values on the UI Lables, based on the current bill.
